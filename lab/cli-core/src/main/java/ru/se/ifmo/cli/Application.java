...
public abstract class Application {
     ...
     */
    public abstract <T extends CollectionManager<?>> DatabaseManager<T> getDatabaseController();

    /**
     * @param <T> entity type
     * @return collection controller for the app
     */
    public abstract <T extends Entity> CollectionManager<T> getCollectionController();
    ...
    public  static <T extends Application> T launch() {
        ...
        Injector injector = Guice.createInjector(
            new ProjectModule(app.getCollectionController(),
                app.getDatabaseController()));
    ...
    public static void execute(String[] args) {
        ...
        try {
            ...
            logger.warn("Invalid command format; use 'help' for usage", e);
            return;
        }
