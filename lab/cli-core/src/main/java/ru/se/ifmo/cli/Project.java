...
public interface Project {
    ...
    SQLConnectionController getSQLConnectionController();
     ...
     */
    <T extends CollectionManager<?>> DatabaseManager<T> getDatabaseManager();
     ...
     */
    <T extends Entity> CollectionManager<T> getCollectionManager();
}
