...
public class ProjectImpl implements Project {
    ...
    private final SQLConnectionController sqlConnectionController;
    private final DatabaseManager<?> databaseManager;
    private final CollectionManager<?> collectionManager;

    @Inject
    public ProjectImpl(CommandContainer commandContainer,
                       Parser parser, SQLConnectionController sqlConnectionController,
        ...
        this.sqlConnectionController = sqlConnectionController;
    ...
    @Override
    public SQLConnectionController getSQLConnectionController() {
        return sqlConnectionController;
    }

    @SuppressWarnings("unchecked")
    @Override
    public <T extends CollectionManager<?>> DatabaseManager<T> getDatabaseManager() {
        return (DatabaseManager<T>) databaseManager;
    }

    @SuppressWarnings("unchecked")
    @Override
    public <T extends Entity> CollectionManager<T> getCollectionManager() {
